...
@php $adminprofile = App\Http\Controllers\HomeController::getGeneralSetting() @endphp
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('dashboard')}}" class="brand-link">
            <img src="{{asset('images/cms/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Bright CMS</span>
        </a>
        <!-- Sidebar -->
        <div class="sidebar">
            ...
            <nav class="mt-2">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ route('dashboard') }}"><i class="fa fa fa-bars nav-icon"></i> <p> Dashboard</p></a></li>
                    ...
                    {{-- <li class="nav-item"><a href="{{route('notice.index')}}" class="nav-link"><i class="nav-icon fa fa-bullhorn"></i><p>Notices <span class="right badge badge-danger">New</span></p></a></li> --}}
                    <li class="nav-item"><a href="{{route('slide.index')}}" class="nav-link"><i class="nav-icon fa fa-th"></i><p>Slider {{-- <span class="right badge badge-danger">New</span>--}}</p></a></li>
                    {{-- <li class="nav-item"><a href="{{route('careers.index')}}" class="nav-link"><i class="nav-icon fa fa-briefcase"></i><p>Career<span class="right badge badge-danger">New</span></p></a></li> --}}
                    {{-- <li class="nav-item"><a href="{{route('calendars.index')}}" class="nav-link"><i class="nav-icon fa fa-calendar"></i><p>Calendar<span class="right badge badge-danger">New</span></p></a></li> --}}
                   
                    {{-- <li class="nav-item"><a href="{{route('quicklinks.index')}}" class="nav-link"><i class="nav-icon fa fa-mouse-pointer"></i><p>Quick Links </p></a></li> --}}
                    ...
                    {{-- <li class="nav-item"><a href="{{route('college.index')}}" class="nav-link"><i class="nav-icon fa fa-building"></i><p>Profile </p></a></li> --}}

                    {{-- <li class="nav-item"><a href="{{route('seo.index')}}" class="nav-link"><i class="nav-icon fa fa-search"></i><p>SEO</i></p></a></li> --}}
