        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">News and Event Update                                            <a href="{{route('blog.index')}}" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> &nbsp; Back</a>
                    </h3>
                    ...
                    <form action="{{route('blog.update',$blog->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{$blog->title}}" placeholder="Enter News & Event Name" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                @foreach($blog->images as $image)
                                    ...
                                    <img src="{{asset('images/blog/'.$image)}}" width="150px;">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <textarea id="editor1" name="editor1" style="width: 100%"> {{$blog->summary}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <label for="name">Details</label>
                            <div class="col-md-12">
                                <input type="checkbox" name="status" value="1" @if($blog->publish == 1) checked @endif>
                            </div>
                        </div>
