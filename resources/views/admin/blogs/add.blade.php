        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">New News &  Events                                             <a href="{{route('blog.index')}}" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> &nbsp; Back</a>
                    </h3>
                    ...
                    <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Enter Title" value="{{ old('name') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <textarea id="editor1" name="editor1" style="width: 100%">{{ old('editor1') }}</textarea>
                                </div>
                            </div>
                        </div>

                        <div class="row">
                            <label for="name">Check below if you want to publish </label>
                            <div class="col-md-12">
