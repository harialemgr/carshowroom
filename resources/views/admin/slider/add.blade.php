    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">New Slide                                             <a href="{{route('slide.index')}}" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> &nbsp; Back</a>
                </h3>
          ...
          <div class="form-group col-md-6">
              ...
              <div class="input-group">
                  ...
                  <div class="form-group">
                      <label>Check below if you want to show to homepage slider</label>
                      <div class="checkbox">
