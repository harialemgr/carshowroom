        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">New Branch                                            <a href="{{route('branch.index')}}" class="btn btn-success pull-right"><i class="fa fa-list"></i> &nbsp; All Branches</a>
                    </h3>
                    ...
                    <form action="{{route('branch.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name" placeholder="Branch Name" value="{{ old('name') }}" required>
                                @if($errors->has('name'))
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control  {{ $errors->has('address') ? 'is-invalid' : '' }}"  name="address" placeholder="Enter Address" value="{{ old('address') }}" required>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control  {{ $errors->has('email') ? 'is-invalid' : '' }}" name="email" placeholder="Enter email address" value="{{ old('email') }}" required>
                                @if($errors->has('email'))
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control  {{ $errors->has('contact') ? 'is-invalid' : '' }}" name="contact" placeholder="Enter Contact Number" value="{{ old('contact') }}" required>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                {!! Form::select('branch_type', array('head' => 'Head Branch', 'child' => 'Child Branch'), null, ['class' => ($errors->has('branch_type') ? 'form-control is-invalid' : 'form-control'), 'placeholder' => 'Choose ...']) !!}
                                @if($errors->has('branch_type'))
                                 <span class="invalid-input">{{ $errors->first('branch_type') }}</span>
                                @endif
