        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">New Video                                             <a href="{{route('gallery.index')}}" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> &nbsp; Back</a>
                    </h3>
                    ...
                    <form action="{{route('videos.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <label>Video Link</label>
                                <input class="form-control" type="text" id="videolink" name="video" placeholder="Enter Video Link">
                            </div>
                        </div>
