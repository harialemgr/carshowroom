        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Notice Update                                            <a href="{{route('notice.index')}}" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> &nbsp; Back</a>
                    </h3>
                    ...
                    <form action="{{route('notice.update',$notice->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            {{--<div class="form-group col-md-3">
                                ...
                                <select class="form-control" name="category" required>
                                    @foreach($member_categories as $category)
                                        <option value="{{$category->id}}" @if($notice->member_category_id == $category->id) selected @endif >{{$category->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                            --}}
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="{{$notice->title}}" placeholder="Enter Notice Title" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    <textarea id="editor1" name="description" style="width: 100%"> {{$notice->description}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                @foreach($notice->images as $image)
                                    ...
                                    <img src="{{asset('images/notice/'.$image)}}" width="150px;">
                       ...
                       {{--<div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <textarea id="editor1" name="editor1" style="width: 100%"> {{$notice->summary}}</textarea>
                                </div>
                            </div>
                        </div>
                        --}}
                        <div class="row">
                            <label for="name">Details</label>
                            <div class="col-md-12">
                                <input type="checkbox" name="status" value="1" @if($notice->publish == 1) checked @endif>
                            </div>
                        </div>
