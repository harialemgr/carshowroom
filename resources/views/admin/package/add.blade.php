        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Package                                             <a href="{{route('back')}}" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> &nbsp; Back</a>
                    </h3>
                ...
                <form action="{{route('package.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="name" name="duration" placeholder="Enter Package duration" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="name">Minimum Amount</label>
                            <input type="text" class="form-control" id="name" name="amount" placeholder="Enter Package minimum amount" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="name">Group Size</label>
                            <input type="text" class="form-control" id="name" name="group_size" placeholder="Enter Package Group size" required>
                        </div>
                    </div>
                    <div class="row">
