        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">New Description                                             <a href="{{route('page.index')}}" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> &nbsp; Back</a>
                    </h3>
                    ...
                    <form action="{{route('page.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="name">Description For</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Page Name" required>
                        ...
                        <div class="row">
                            <label for="name">Check below if you want to dispay to homepage</label>
                            <div class="col-md-12">
