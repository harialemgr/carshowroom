        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Page Update                                            <a href="{{route('page.index')}}" class="btn btn-warning pull-right"><i class="fa fa-backward"></i> &nbsp; Back</a>
                    </h3>
                    ...
                    <form action="{{route('page.update',$page->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control" name="category" required>
                                    @foreach($page_categories as $category)
                                        <option value="{{$category->id}}" @if($page->page_category_id == $category->id) selected @endif >{{$category->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="name">Page Name</label>
                                <input type="text" class="form-control" id="name" name="name" value="{{$page->title}}" placeholder="Enter Page Name" required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                @foreach($page->images as $image)
                                    ...
                                    <img src="{{asset('images/page/'.$image)}}" width="150px;">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <textarea id="editor1" name="editor1" style="width: 100%"> {{$page->summary}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <label for="name">Check below if you want to publish to homepage</label>
                            <div class="col-md-12">
                                <input type="checkbox" name="status" value="1" @if($page->publish == 1) checked @endif>publish
                            </div>
                        </div>
